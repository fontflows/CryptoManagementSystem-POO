...
public class InvestmentProjectionService {
    ...
    public static double calculateInvestmentProjection (double coinAmount, double price, double growthRate, int months){
        ...
        if (price <= 0) { throw new IllegalArgumentException("Preco nao pode ser negativo ou nulo"); }
    ...
    public static int calculateTimeToTarget (double coinAmount, double price, double growthRate, double targetValue){
